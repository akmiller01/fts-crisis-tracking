...
script.dir = "/home/alex/git/fts-crisis-tracking/"

isos = read.csv(paste0(script.dir,"fts_isos.csv"), na.strings="", as.is=T, fileEncoding="utf8")
...
fts.flow(boundary=b, auth=NULL, con, table.quote, new_table)

fts2020 = dbReadTable(con, name=table.quote)
dbDisconnect(con)
fwrite(fts2020,"fts2020.csv")